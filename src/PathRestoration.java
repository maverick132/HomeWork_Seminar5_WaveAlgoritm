public class PathRestoration {
    ...
    public static void printToConsoleWay(Field field) {
        ...
        for (int i = 0; i < field.sizeHeight; i++) {// Вычисляем длину наибольшего элемента в массиве
        ...
        for (int i = 0; i < fieldForPrint.sizeHeight; i++) {// Вычисляем длину наибольшего элемента в массиве
